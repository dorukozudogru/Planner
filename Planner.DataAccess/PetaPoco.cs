...
namespace PetaPoco
{
	...
	public class Database : IDisposable
	{
		...
		void AddParam(IDbCommand cmd, object value, PropertyInfo pi)
		{
			...
			else
			{
				...
				var t = value.GetType();
				if (t.IsEnum)		// PostgreSQL .NET Log wont cast enum to int
				{
					p.Value = (int)value;
				}
	...
	Logs that don't include include it.  For later versions of Oracle, the standard OracleProviderFactory
